...
# Test 5b: readinto (file and BytesIO)
print("\n--- Test 5b: readinto ---")
f = open("/tmp/loretta_test.txt", "rb")
b = bytearray(32)
n = f.readinto(b)
print("readinto file n:", n)
print("readinto file bytes:", bytes(b[:n]))
f.close()
buf = io.BytesIO(b"readinto works")
b = bytearray(64)
n = buf.readinto(b)
print("readinto BytesIO n:", n)
print("readinto BytesIO bytes:", bytes(b[:n]))
